...
$(document).ready(function() {
	...
	function openModal(modalId) {
		var otherModalId = (modalId === '#tg-login') ? '#tg-register' : '#tg-login';
	...
	$('#open-login').click(function(e) {
		...
		openModal('#tg-login'); // Abre el modal de Iniciar Sesión
	});

	// Abrir el modal de Registrarse
	$('#open-register').click(function(e) {
		e.preventDefault(); // Previene el comportamiento por defecto del enlace
		openModal('#tg-register'); // Abre el modal de Registrarse
	});
});